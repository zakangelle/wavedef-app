...
export default class RatPoisonUI extends React.Component
{
  componentWillMount()
  {
    this.ratPoison = new RatPoison();
  }

  render()
  {
    let { oscGroup, mixer, filter, envelope } = this.ratPoison;
